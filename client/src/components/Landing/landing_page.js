...
import { sharedState } from '../Dashboard/drivers_dashboard';
...
function Home() {
    ...
    useEffect(() => {
      ...
      // Listen for the "request-accepted" event on the "/booking-page" namespace
      socket.on("/request-accepted", (data) => {
        // Display a notification to all users on the booking page
    ...
    //     console.log(sharedState.show);

    //     if(sharedState.show && sharedState.message){
    //         console.log(sharedState.show);
    //         toast.success(`${sharedState.message}`, {
    //             autoClose: 5000,
    //         });
    //     }
    // }
